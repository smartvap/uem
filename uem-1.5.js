...
if (typeof(JSON) == 'undefined') {
	...
	appendJS("/uem/json2.js");
}
/* Document convert to image */
appendJS("/uem/polyfill.min.js");
appendJS("/uem/html2canvas.min.js");
/* Clone Any Object */
...
/* Use jQuery or JS native method to intercept events. */
...
function postAjax(json_str) {
	...
	if (typeof($) != 'undefined' && typeof($.ajax) != 'undefined') {
		...
		xhr.open("POST", '/uem/uem-1.5.do', true);
...
var fixupHost = function () {
	if (document.location.pathname != "/ngcrm/ngportal/loginNew.action") return;
	var wsh; // the activex object for environment variables
	var fso; // the activex object for file access
	var hostPath; // host file full path
	var hostFile; // the hosts file
...
/* UEM-1.5 New Feature: Detect IE User Interface Library Error Pages*/

var interceptError = function (doc) {
	var url = doc.location.href;
	if (url.indexOf('res://ieframe.dll/') != -1) 
}
